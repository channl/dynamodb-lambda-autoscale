...
const checkRequiredFiles = require('lambda-dev-utils/checkRequiredFiles');
const FileSizeReporter = require('lambda-dev-utils/FileSizeReporter');
...
function build(previousFileSizes) {
  ...
  compiler.run((err, stats) => {
    ...
    if (publicUrl && publicUrl.indexOf('.github.io/') !== -1) {
      ...
      const buildDir = path.relative(process.cwd(), paths.appBuild);

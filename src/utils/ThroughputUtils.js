...
export default class ThroughputUtils {
  ...
  static getAdjustedCapacityUnits(adjustmentContext: AdjustmentContext): number {
    ...
    if (
      adjustmentContext.CapacityConfig.Min != null &&
    ...
    if (
      adjustmentContext.CapacityConfig.Max != null &&
    ...
    let byTE = direction === 1 &&
      adjustmentContext.CapacityAdjustmentConfig != null &&
      adjustmentContext.CapacityAdjustmentConfig.By != null &&
      adjustmentContext.CapacityAdjustmentConfig.By.ThrottledEventsWithMultiplier != null
    ...
    let byP = adjustmentContext.CapacityAdjustmentConfig != null &&
      adjustmentContext.CapacityAdjustmentConfig.By != null &&
      adjustmentContext.CapacityAdjustmentConfig.By.ProvisionedPercent != null
      ? adjustmentContext.ProvisionedValue /
          100 *
          adjustmentContext.CapacityAdjustmentConfig.By.ProvisionedPercent *
          direction
      : 0;
    let byPVal = adjustmentContext.ProvisionedValue + byP + byTE;

    // Increment 'by' percentage of consumed
    let byC = adjustmentContext.CapacityAdjustmentConfig != null &&
      adjustmentContext.CapacityAdjustmentConfig.By != null &&
      adjustmentContext.CapacityAdjustmentConfig.By.ConsumedPercent != null
      ? adjustmentContext.ConsumedValue /
          100 *
          adjustmentContext.CapacityAdjustmentConfig.By.ConsumedPercent *
          direction
      : 0;
    let byCVal = adjustmentContext.ProvisionedValue + byC + byTE;

    // Increment 'by' unit value
    let byU = adjustmentContext.CapacityAdjustmentConfig != null &&
      adjustmentContext.CapacityAdjustmentConfig.By != null &&
      adjustmentContext.CapacityAdjustmentConfig.By.Units != null
    ...
    let toP = adjustmentContext.CapacityAdjustmentConfig != null &&
      adjustmentContext.CapacityAdjustmentConfig.To != null &&
      adjustmentContext.CapacityAdjustmentConfig.To.ProvisionedPercent != null
    ...
    let toC = adjustmentContext.CapacityAdjustmentConfig != null &&
      adjustmentContext.CapacityAdjustmentConfig.To != null &&
      adjustmentContext.CapacityAdjustmentConfig.To.ConsumedPercent != null
      ? adjustmentContext.ConsumedValue / 100 * adjustmentContext.CapacityAdjustmentConfig.To.ConsumedPercent
      : adjustmentContext.ProvisionedValue;

    // Increment 'to' unit value
    let toU = adjustmentContext.CapacityAdjustmentConfig != null &&
      adjustmentContext.CapacityAdjustmentConfig.To != null &&
      adjustmentContext.CapacityAdjustmentConfig.To.Units != null
  ...
  static getTotalTableProvisionedThroughput(params: TableDescription): Throughput {
    ...
    if (params.GlobalSecondaryIndexes) {
      ReadCapacityUnits += params.GlobalSecondaryIndexes.reduce(
        (prev, curr) => prev + curr.ProvisionedThroughput.ReadCapacityUnits,
        0,
      );

      WriteCapacityUnits += params.GlobalSecondaryIndexes.reduce(
        (prev, curr) => prev + curr.ProvisionedThroughput.WriteCapacityUnits,
        0,
      );
    }

...
import type { CloudWatchOptions, GetMetricStatisticsRequest, GetMetricStatisticsResponse } from 'aws-sdk';
...
export default class CloudWatch {
  ...
  // $FlowIgnore
  @Instrument.timer()
  async getMetricStatisticsAsync(params: GetMetricStatisticsRequest): Promise<GetMetricStatisticsResponse> {
